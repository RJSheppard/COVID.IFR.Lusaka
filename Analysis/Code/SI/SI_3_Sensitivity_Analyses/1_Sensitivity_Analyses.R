...
saveRDS(S1_Res, file = "Analysis/Results/SI_Sensitivity_Analysis_1_Remove_Age_gr_1.rds")
...
saveRDS(S2_Res, file = "Analysis/Results/SI_Sensitivity_Analysis_2_No_scaling_no_weeks_4_or_5.rds")
...
saveRDS(S3_Res, file = "Analysis/Results/SI_Sensitivity_Analysis_3_Only_burials_and_pop_prevalence.rds")
...
######################
dfj_mcmc_data_lower_10 <- readRDS(file = "Analysis/Data/derived_data/00_16_03_drj_mcmc_data_new_pop_str_2_lower_rr_10.rds")
...
saveRDS(S4a_Res, file = "Analysis/Results/SI_Sensitivity_Analysis_4a_Change_age_RR_lower_10.rds")

######################
## Sensitivity 4b: Change relative rates by 20%: Higher
######################
dfj_mcmc_data_higher_10 <- readRDS(file = "Analysis/Data/derived_data/00_16_03_drj_mcmc_data_new_pop_str_2_higher_rr_10.rds")
...
saveRDS(S4b_Res, file = "Analysis/Results/SI_Sensitivity_Analysis_4b_Change_age_RR_higher_10.rds")
...
######################
dfj_mcmc_data_lower_20 <- readRDS(file = "Analysis/Data/derived_data/00_16_03_drj_mcmc_data_new_pop_str_2_lower_rr_20.rds")
...
saveRDS(S4c_Res, file = "Analysis/Results/SI_Sensitivity_Analysis_4c_Change_age_RR_lower_20.rds")
...
######################
dfj_mcmc_data_higher_20 <- readRDS(file = "Analysis/Data/derived_data/00_16_03_drj_mcmc_data_new_pop_str_2_higher_rr_20.rds")
...
saveRDS(S4d_Res, file = "Analysis/Results/SI_Sensitivity_Analysis_4d_Change_age_RR_higher_20.rds")
...
saveRDS(S5aRes, file = "Analysis/Results/SI_Sensitivity_Analysis_5a_Change_duration_to_death_lower.rds")
...
saveRDS(S5bRes, file = "Analysis/Results/SI_Sensitivity_Analysis_5b_Change_duration_to_death_higher.rds")
