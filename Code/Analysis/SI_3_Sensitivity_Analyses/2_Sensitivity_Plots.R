...
##########################
devtools::load_all()
Res_Sens_1 <- readRDS("Results/Sensitivity_Analysis_1_Remove_Age_gr_1.rds")
...
pdf("Figures/SI/Sens_1_remove_age_1.pdf", height = 3.5, width = 6)
sp1
dev.off()
tiff("Figures/SI/Sens_1_remove_age_1.tiff", height = 3.5, width = 6, units = "in", res = 300)
sp1
dev.off()
...
##########################
devtools::load_all()
Res_Sens_2 <- readRDS("../Bonus Files/2022-11-22_Sensitivity_Analysis_2_No_scaling_no_weeks_4_or_5.rds")
Res_LL_only_Sens_2 <- lapply(X =1:length(Res_Sens_2), FUN = Diagnostic_Plot_10, fit_Model_list = Res_Sens_2, IFRvals = IFR_coefficients[Select_Runs,],
                                Return_likelihoods_only = T)
saveRDS(Res_LL_only_Sens_2, "../Bonus Files/Heatmap_data_results_Sens_2_No_scaling_no_weeks_4_or_5.rds")
# Res_LL_only_Sens_2 <- readRDS("../Bonus Files/Heatmap_data_results_Sens_2_Remove_Age_gr_1")

# names(Res_Sens_2) <- paste0("X",1:71)[Select_Runs]
...
pdf("Figures/SI/Sens_2_no_scaling_no_weeks_4_5.pdf", height = 3.5, width = 7)
sp2
dev.off()
tiff("Figures/SI/Sens_2_no_scaling_no_weeks_4_5.tiff", height = 3.5, width = 7, units = "in", res = 300)
sp2
dev.off()
...
Res_Sens_3 <- readRDS("Results/SI/Sensitivity_3_Only_burials_and_pop_prevalence.rds")
...
pdf("Figures/SI/Sens_3_Only_burials_and_pop_prevalence.pdf", height = 3, width = 7)
sp3
dev.off()
tiff("Figures/SI/Sens_3_Only_burials_and_pop_prevalence.tiff", height = 3, width = 7, units = "in", res = 300)
sp3
dev.off()
...
#######################################
#######################################
Res_Sens_4a <- readRDS("../Bonus Files/1022-11-19_Sensitivity_Analysis_4a_Change_age_RR_lower_10.rds")
...
pdf("analysis/figures/52_Sens_4a_Change_age_RR_lower_10.pdf", height = 3.5, width = 8)
sp4a
dev.off()
tiff("analysis/figures/52_Sens_4a_Change_age_RR_lower_10.tiff", height = 3.5, width = 8, units = "in", res = 300)
sp4a
dev.off()
...
Res_Sens_4b <- readRDS("Results/SI/Sensitivity_Analysis_4b_Change_age_RR_higher_10.rds")
...
pdf("Figures/SI/Sens_4b_Change_age_RR_higher_10.pdf", height = 3.5, width = 7.5)
sp4b
dev.off()
tiff("Figures/SI/Sens_4b_Change_age_RR_higher_10.tiff", height = 3.5, width = 7.5, units = "in", res = 300)
sp4b
dev.off()
...
#######################################
#######################################
Res_Sens_4c <- readRDS("Results/SI/Sensitivity_Analysis_4c_Change_age_RR_lower_20.rds")
...
pdf("Figures/SI/Sens_4c_Change_age_RR_lower_20.pdf", height = 3.5, width = 6)
sp4c
dev.off()
tiff("Figures/SI/Sens_4c_Change_age_RR_lower_20.tiff", height = 3.5, width = 6, units = "in", res = 300)
sp4c
dev.off()
...
#######################################
#######################################
Res_Sens_4d <- readRDS("Results/SI/Sensitivity_Analysis_4d_Change_age_RR_higher_20.rds")
...
pdf("Figures/SI/Sens_4d_Change_age_RR_higher_20.pdf", height = 3.5, width = 6)
sp4d
dev.off()
tiff("Figures/SI/Sens_4d_Change_age_RR_higher_20.tiff", height = 3.5, width = 6, units = "in", res = 300)
sp4d
dev.off()
...
Res_Sens_5a <- readRDS("Results/SI/Sensitivity_Analysis_5a_Change_duration_to_death_lower.rds")
...
pdf("Figures/SI/Sens_5a_Change_duration_to_death_lower.pdf", height = 3, width = 6)
sp5a
dev.off()
tiff("Figures/SI/Sens_5a_Change_duration_to_death_lower.tiff", height = 3, width = 6, units = "in", res = 300)
sp5a
dev.off()
...
Res_Sens_5b <- readRDS("Results/SI/Sensitivity_Analysis_5b_Change_duration_to_death_higher.rds")
...
pdf("Figures/SI/Sens_5b_Change_duration_to_death_higher.pdf", height = 3, width = 6)
sp5b
dev.off()
tiff("Figures/SI/Sens_5b_Change_duration_to_death_higher.tiff", height = 3, width = 6, units = "in", res = 300)
sp5b
dev.off()
